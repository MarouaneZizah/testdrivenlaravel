...
class PurchaseTicketsTest extends TestCase {
    ...
    public function customer_can_purchase_tickets_to_a_published_concert() {
        $concert = Concert::factory()->published()->create(['price' => 3250])->addTickets(3);
        ...
        $this->assertTrue($concert->hasOrderFor('john@example.org'));
        $this->assertEquals(3, $concert->ordersFor('john@example.org')->first()->ticketQuantity());
    }
